function [E_old,xs_old] = p_data_O2_vib_03()
...
O2_vib_allan = ([0 0 0 0 0.06 5.6 16 21 18 12 6.9 3.7 1.9 0.85 0.38 0.18 0.09 0 0 0]/delta_E_th_itiawka)'...
    *1e-20*cm_to_m^2; 
...
xs_allan_O2_vib_03 = load('xs_allan_O2_vib_03.mat'); 
E_old_vib_O2_he = xs_allan_O2_vib_03.xs_allan_O2_vib_03(:,1)*eVtoJ; % J
xs_old_vib_O2_he = xs_allan_O2_vib_03.xs_allan_O2_vib_03(:,2)*1e-19*cm_to_m^2*all_angles; 
