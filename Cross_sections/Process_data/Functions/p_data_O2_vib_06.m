function [E_old,xs_old] = p_data_O2_vib_06()
...
O2_vib_allan = ([0 0 0 0 0 0 0 0 0.02 0.21 0.15 0.015 0.018 0.069 0.1 0.096 0.068 0.052 0.035 0.019]/delta_E_th_itiawka)'...
    *1e-20*cm_to_m^2; 
...
xs_allan_O2_vib_06 = load('xs_allan_O2_vib_06.mat'); 
E_old_vib_O2_he = xs_allan_O2_vib_06.xs_allan_O2_vib_06(:,1)*eVtoJ; % J
xs_old_vib_O2_he = xs_allan_O2_vib_06.xs_allan_O2_vib_06(:,2)*1e-19*cm_to_m^2*all_angles; 
