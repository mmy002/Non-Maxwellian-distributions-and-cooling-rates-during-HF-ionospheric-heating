function [E_old,xs_old] = p_data_O2_vib_04()
...
O2_vib_allan = ([0 0 0 0 0 0.31 0.36 0.35 2.1 3.3 3.1 2.2 1.11 0.88 0.44 0.25 0.1 0.06 0 0]/delta_E_th_itiawka)'...
    *1e-20*cm_to_m^2; 
...
xs_allan_O2_vib_04 = load('xs_allan_O2_vib_04.mat'); 
E_old_vib_O2_he = xs_allan_O2_vib_04.xs_allan_O2_vib_04(:,1)*eVtoJ; % J
xs_old_vib_O2_he = xs_allan_O2_vib_04.xs_allan_O2_vib_04(:,2)*1e-19*cm_to_m^2*all_angles; 
