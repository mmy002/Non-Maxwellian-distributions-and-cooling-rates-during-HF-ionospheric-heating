...
% html-documentation of the m-source code in Code_data_publish_new. This
...
% logigal order, and for a nicer display it is necessary to modify 
% the css-files.
...
%% Run
doc_dir = ['Html-code-D',datestr(now,'yyyymmdd')];
m2html('mfiles',dirs4doc,...
       'htmldir',doc_dir,... % Default directory for documentation
