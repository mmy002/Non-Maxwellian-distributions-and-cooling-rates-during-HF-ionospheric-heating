function [L_SI] = cooling_rates_tables_pavlov_tot(Te,Tn,nNe,nO,nN2,nO2)
...
% .........................................................................
% Output: Sum of cooling rates [eV/(cm^3*s)] 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if Te <= 1500
  ...
  % 11 from paper: 
  L_vib_N2 = nNe_cm_neg3*nN2_cm_neg3*(1-exp(-E1/T_vib_N2))*...
	     sum_AA + nNe_cm_neg3*nN2_cm_neg3*(1-exp(-E1/T_vib_N2))*exp(-E1/T_vib_N2)*sum_BB; 
...
% Equation 15 from the paper by Pavlov and Berringston (1999)
L_oxygen_15 = nNe_cm_neg3.*nO_cm_neg3.*(1./D).*(S10 .* (1-exp(98.9*((1./Te)-(1./Tn)))) + ...
						S20  * (1-exp(326.6*((1./Te)-(1./Tn)))) + ...
						S21  * (1-exp(227.7*((1./Te)-(1./Tn))))); % [eVcm^-3s^-1]
...
for vv = 1:7
  Q_0v_O2_pavlov(vv) = coef_matrix_Q0v_02_Pavlov(vv,2) * ...
			   ...
			   (coef_matrix_Q0v_02_Pavlov(vv,4) + coef_matrix_Q0v_02_Pavlov(vv,5) * ...
							      sin(coef_matrix_Q0v_02_Pavlov(vv,6) * ...
...
L_vib_O2_pavlov = nNe_cm_neg3*nO2_cm_neg3*sum_A_O2_pavlov; % [eVcm^-3s^-1] 
...
E_1_sigma_O2 = 0.977; 
g1_g0        = 5/3; 
L_sigma_O2  = nNe_cm_neg3 .* nO2_cm_neg3 * G_Te * (1 - exp(-11400/Tn) * g1_g0 * exp(E_1_sigma_O2/Te)); 

f2           = (19225 + 560*sin(0.000383*(Te-1000)))*(1 + exp((Te-16382)/1760)); 
H_Te         = 1.616e-16*exp(f2*(1/1500 - 1/Te)); 
E_2_sigma_O2 = 1.627; 
g2_g0        = 1/3; 
L_delta_O2   = nNe_cm_neg3 .* nO2_cm_neg3 * H_Te * (1 - exp(-11400/Tn)*g2_g0*exp(E_2_sigma_O2/Te)); 
...
L_oxygen_15_SI     = L_oxygen_15     * eVtoJ * cm_neg3_to_m_neg3; %[Jm^-3s^-1]
L_vib_N2_SI        = L_vib_N2        * eVtoJ * cm_neg3_to_m_neg3; %[Jm^-3s^-1]
L_rot_N2_SI        = L_rot_N2        * eVtoJ * cm_neg3_to_m_neg3; %[Jm^-3s^-1]
L_vib_O2_SI_pavlov = L_vib_O2_pavlov * eVtoJ * cm_neg3_to_m_neg3; %[Jm^-3s^-1]
L_rot_O2_SI        = L_rot_O2        * eVtoJ * cm_neg3_to_m_neg3; %[Jm^-3s^-1]
L_sigma_O2_SI      = L_sigma_O2      * eVtoJ * cm_neg3_to_m_neg3; %[Jm^-3s^-1]
L_delta_O2_SI      = L_delta_O2      * eVtoJ * cm_neg3_to_m_neg3; %[Jm^-3s^-1]
L_elas_SI          = L_elas          * eVtoJ * cm_neg3_to_m_neg3; 

%% Total cooling rate of electrons in SI-units
L_SI = L_oxygen_15_SI + L_vib_N2_SI + L_rot_N2_SI + L_vib_O2_SI_pavlov + L_rot_O2_SI + L_sigma_O2_SI + ...
       L_delta_O2_SI + L_elas_SI; 
