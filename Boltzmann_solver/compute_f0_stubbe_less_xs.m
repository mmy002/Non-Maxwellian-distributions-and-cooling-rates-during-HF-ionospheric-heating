function [f0_save,v_bins,Te_non_max,Te_grad,A_save,dI_sum,dIe,deg_Ie] = ...
    compute_f0_stubbe_less_xs(E0_field,n_e,Tn,nO,nN2,nO2,f_HF,xs_data,max_E)
...
% structure excitation of O, and vibrational excitation of O2 for 0 to 1
...
nN_i = [nN2; nN2; nN2; nN2; nN2; nN2; nN2; nN2; nN2; nN2; nO2; nO2; ...
	nO; nO; nO; nO; nO; nO2]; 
...
xs_e_Ofine_1_0 = sigma_O_fine_str_10(E_in, xs_data{21}(:,1), xs_data{21}(:,2));  
xs_e_Ofine_2_0 = sigma_O_fine_str_20(E_in, xs_data{22}(:,1), xs_data{22}(:,2)); 
xs_e_Ofine_2_1 = sigma_O_fine_str_21(E_in, xs_data{23}(:,1), xs_data{23}(:,2));  
xs_e_O3P1D     = sigma_O_3P_1D(E_in, xs_data{24}(:,1), xs_data{24}(:,2)); 
xs_e_O3P1S     = sigma_O_3P_1S(E_in, xs_data{25}(:,1), xs_data{25}(:,2)); 
xs_e_O2vib     = sigma_O2_vib( E_in, xs_data{26}(:,1), xs_data{26}(:,2));
xs_i = [xs_e_N2vib0_1 xs_e_N2vib0_2 xs_e_N2vib0_3 xs_e_N2vib0_4 xs_e_N2vib0_5 ...
        ...
        xs_e_O2a1Dg xs_e_O2b1Sgp xs_e_Ofine_1_0 xs_e_Ofine_2_0 xs_e_Ofine_2_1 ...
        xs_e_O3P1D xs_e_O3P1S xs_e_O2vib];
...
% Resolution  of speed(constant) [J]
